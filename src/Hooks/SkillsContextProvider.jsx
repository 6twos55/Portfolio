...
const ProjectsData = [
  {
    ...
    prName: "Aara Fitness",
    prSiteLink: "https://aara-bay.vercel.app/",
    prDes:
      "Showcase and onboarding website for a Fitness company. Built with Next.js and TailwindCSS.",
  ...
  },
  {
    ...
    prDes:
      "Blog posting application created with MERN stack. Add, delete and update your posts.",
  ...
  },
  {
    ...
    prDes:
      "Portfolio website for a Brand designer & Artist. Built with Next.js and TailwindCSS.",
  ...
  },
  {
    ...
    prDes:
      "Space shooter game. Shoot falling rocks and earn points. Desktop views only.",
...
export const SkillsContextProvider = ({ children }) => {
  ...
  return (
    <SkillsContext.Provider
      value={{ codeSnippets, skills, technologies, Projects: ProjectsData }}
    >
      {children}
    </SkillsContext.Provider>
  );
